	...
	<div class="scounger_main__left">
		<form action="" method="post">
			...
			<div>
				...
				<p>
					<input type="text" name="scrounger[account]" value="<?php echo intval( get_option( 'scrounger_account' ) ); ?>" placeholder="<?php _e( 'Номер кошелька в сервисе Янденкс.Деньги', 'scrounger-lite' ); ?>" style="width: calc(100% - 50px);margin: 10px auto;"/>
				</p>
